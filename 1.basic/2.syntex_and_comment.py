...
# hash ke sath hum single line comment dete hai
'''
ye mltiline
comment
hai
'''
# print() = ye small bracke jab bhi use ho iska matlab hai ki ye ek function hai.
# agar function pahle se bana hua hai to ye predefined function hota hai

print('\n\nHello welcome to hey kya karu')

# file handling
'''
jaise hamere system me hum ek file ke sath
new file creat 
existing file to rename
existing file to delte
...
'''
Python Database Handling (CRUD)

create = ya to database creat ya table
read = use select query
update = modify existing data
delete = existing data ko delete karna
'''
...
if 8 > 5:
    print('Ha 4 jo hai 5 se bada hia')
    print('Ha 4 jo hai 5 se bada hia')
